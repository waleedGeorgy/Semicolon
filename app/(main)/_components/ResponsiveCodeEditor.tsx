...
export default function ResponsiveResizableGroup() {
    ...
    return (
        ...
        >
            ...
            <ResizableHandle className={`${isLgScreen ? "mx-1.5 w-1.5 h-auto" : "my-1.5 min-h-1.5"} bg-gray-600 hover:bg-indigo-400 duration-150 transition-all ease-in-out rounded-full`} />
            <ResizablePanel defaultSize={50} minSize={isLgScreen ? 0 : 6.5}>
                <OutputPanel />
            </ResizablePanel>
        </ResizablePanelGroup>
